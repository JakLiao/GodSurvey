...
public class Paper {
	...
	public Paper(int paperId, int userId, String paperTitle,
			String paperSummary, String paperStartDate, String paperEndDate,
			String paperBg, int paperType, int paperStatus, int paperCount) {
		super();
		this.paperId = paperId;
		this.userId = userId;
		this.paperTitle = paperTitle;
